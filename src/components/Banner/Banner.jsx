    ...
    <div className="relative z-50 pb-12 text-white bg-black">
      <div className="container">
        <div className="grid items-center grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <img data-aos="zoom-in" src={Satelite} alt="" className="w-full sm:w-[80%] mx-auto max-h-[350px] object-cover" />
          </div>
          <div className="p-4 space-y-3 border-b-2 border-r-2 border-r-sky-800 border-b-sky-800 xl:pr-36">
